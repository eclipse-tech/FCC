...
membership_count = dim_member.groupBy("WorkshopPincode").agg(countDistinct("MembershipNo").alias("Contractors")).orderBy(col("Contractors").desc())

# Show the results
membership_count.show()